...
user16 = User.create(email: 'email16@email.com', password: '123456', role: "Employment Agency")

user17 = User.create(email: 'email17@email.com', password: '123456', role: "Employment Agency")

user18 = User.create(email: 'email18@email.com', password: '123456', role: "Employment Agency")

user19 = User.create(email: 'email19@email.com', password: '123456', role: "Employment Agency")

user20 = User.create!(email: 'email20@email.com', password: '123456', role: "Employment Agency")

user1 = User.create(email: 'email@email.com', password: '123456', role: "Apprentice",first_name: 'John', last_name: 'Doe')
apprentice1 = Apprentice.new
...
user4 = User.create(email: 'email4@email.com', password: '123456', role: "Apprentice", first_name: 'Johnc', last_name: 'Doec')
apprentice4 = Apprentice.new
apprentice4.user = user4
apprentice4.agency = user19
apprentice4.save

user5 = User.create(email: 'email5@email.com', password: '123456', role: "Apprentice", first_name: 'Johnd', last_name: 'Doed')
apprentice5 = Apprentice.new
apprentice5.user = user5
apprentice5.agency = user20
apprentice5.save

user6 = User.create(email: 'email6@email.com', password: '123456', role: "Host Company (Timesheet Validation)", company_name: "London1, Inc")


user7 = User.create(email: 'email7@email.com', password: '123456', role: "Host Company (Timesheet Validation)", company_name: "London2, Inc")


user8 = User.create(email: 'email8@email.com', password: '123456', role: "Host Company (Timesheet Validation)", company_name: "London3, Inc")


user9 = User.create(email: 'email9@email.com', password: '123456', role: "Host Company (Timesheet Validation)", company_name: "London4, Inc")


user10 = User.create(email: 'email10@email.com', password: '123456', role: "Host Company (Timesheet Validation)", company_name: "London5, inc")


user11 = User.create(email: 'email11@email.com', password: '123456', role: "Host Company (Invoicing)")


user12 = User.create(email: 'email12@email.com', password: '123456', role: "Host Company (Invoicing)")


user13 = User.create(email: 'email13@email.com', password: '123456', role: "Host Company (Invoicing)")


user14 = User.create(email: 'email14@email.com', password: '123456', role: "Host Company (Invoicing)")
