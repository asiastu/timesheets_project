...
placement1 = Placement.create!(apprentice: apprentice1, host_validator: user6, host_invoice_contact: user12, pl_start_date: '11/06/2018', pl_end_date: '01/07/2018', address: 'E5 0EX', interview_date: '31/05/2018', hourly_rate: 7)
placement1a = Placement.create!(apprentice: apprentice1, host_validator: user7, host_invoice_contact: user13, pl_start_date: '01/05/2018', pl_end_date: '08/06/2018', address: 'N1 5AP', interview_date: '30/04/2018', hourly_rate: 7.5)
...
placement1c = Placement.create!(apprentice: apprentice1, host_validator: user8, host_invoice_contact: user11, pl_start_date: '15/03/2018', pl_end_date: '31/03/2018', address: 'N1C 4AG', interview_date: '10/06/2018', hourly_rate: 7)
...
placement6 = Placement.create!(apprentice: apprentice5, host_validator: user10, host_invoice_contact: user15, pl_start_date: '14/05/2018', pl_end_date: '10/06/2018', address: 'N6 5HG', interview_date: '9/12/2017', hourly_rate: 6)
placement6 = Placement.create!(apprentice: apprentice5, host_validator: user10, host_invoice_contact: user15, pl_start_date: '13/06/2018', pl_end_date: '31/08/2018', address: 'UB5 6JS', interview_date: '12/12/2017', hourly_rate: 7)
